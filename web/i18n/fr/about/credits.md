...
cobalt est fabriqué avec amour et soin par l'équipe de recherche et
développement d'[imput](https://imput.net/).
...
un grand merci à nos briseurs de trucs pour avoir testé les mises à jour tôt et
s'être assurés qu'elles sont stables. ils nous ont également aidés à sortir
cobalt 10 ! <BetaTesters />
...
meowbalt est la mascotte rapide de cobalt. c'est un chat extrêmement expressif
qui adore l'internet rapide.

tous les dessins incroyables de meowbalt que vous voyez dans cobalt ont été
réalisés par [GlitchyPSI](https://glitchypsi.xyz/). il est également le
concepteur original du personnage.

vous ne pouvez pas utiliser ou modifier les œuvres de GlitchyPSI de meowbalt
sans sa permission explicite.

vous ne pouvez pas utiliser ou modifier le design du personnage meowbalt
