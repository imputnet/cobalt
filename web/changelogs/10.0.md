...
before we list all the new features, we added support for a couple of new services: facebook, bluesky, loom, and snapchat.
...
- [custom audio bitrate](/settings/audio#bitrate). you can now choose what bitrate to use when processing audio.
...
- [settings data management](/settings/advanced). you can now export, import, or wipe settings.
...
- [convenient updates page](/updates). the new updates page is comfortable to read and navigate. we have also moved to using markdown so that we can do *this* and **this** and ~~that~~. it also includes more changelogs than ever before.
